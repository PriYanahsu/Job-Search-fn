...
export function JobCard({
  ...
  return (
    <article className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm hover:border-slate-300">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="hidden h-10 w-10 shrink-0 rounded-lg border border-slate-200 bg-slate-50 sm:grid sm:place-items-center">
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        <div className="text-xs text-slate-500">Job ID: {job.id}</div>
        <div className="flex items-center gap-2">
          <button
            type="button"
            className="hidden rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 sm:inline-flex"
          >
            Save
          </button>
          <button
